    ...
    fun c02_throw_par2 () {
        val out = all("""
            ...
            set main = task @LOCAL->@[]->()->()->() {
                ...
                var xfg : running task @LOCAL->@[]->()->()->()
                var xh : running task @LOCAL->@[]->()->()->()
                catch {
                    set xfg = spawn fg ()
                    set xh = spawn h ()
