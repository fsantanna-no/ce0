...
class TLexer {
    ...
    fun e01_lincol () {
        ...
        Lexer.lex() ; assert(all().tk1.lin==1 && all().tk1.col==1) ; assert(all().tk1.enu==TK.XID  && (all().tk1 as Tk.Id).id=="c1")
        Lexer.lex() ; assert(all().tk1.lin==5 && all().tk1.col==10) ; assert(all().tk1.enu==TK.XID  && (all().tk1 as Tk.Id).id=="a")
    ...
    fun e03_lincol () {
        All_restart(null, PushbackReader(StringReader("c1 ^[5,10]\na\n^\"test-lincol.ce\"\n^[]\n b"), 2))
        println(all().tk1); Lexer.lex() ; assert(all().tk1.lin==1 && all().tk1.col==1) ; assert(all().tk1.enu==TK.XID  && (all().tk1 as Tk.Id).id=="c1")
        println(all().tk1); Lexer.lex() ; assert(all().tk1.lin==5 && all().tk1.col==10) ; assert(all().tk1.enu==TK.XID  && (all().tk1 as Tk.Id).id=="a")
        println(all().tk1); Lexer.lex() ; assert(all().file=="test-lincol.ce" && all().tk1.lin==1 && all().tk1.col==1) ; assert(all().tk1.enu==TK.XID  && (all().tk1 as Tk.Id).id=="inside")
        println(all().tk1); Lexer.lex() ; assert(all().tk1.lin==5 && all().tk1.col==2) ; assert(all().tk1.enu==TK.XID  && (all().tk1 as Tk.Id).id=="b")
    }
}