...
class TExec {
    ...
    fun m03_scope_f () {
        val out = all("""
            var f: [/</^@1>@1,/</^@3>@3]->()
            set f = func [/</^@1>@1,/</^@3>@3]->() {
                set arg.1\!1 = new <.1 <.0>> @1
                set arg.2\!1 = new <.1 <.0>> @3
            }
            {
                var x: /</^ @local> @local
                set x = new <.1 <.0>> @local
