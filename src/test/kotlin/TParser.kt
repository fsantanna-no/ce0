...
class TParser {
    ...
    @Test
    fun a01_parser_type () {
        All_new(null, PushbackReader(StringReader("xxx"), 2))
        Lexer.lex()
        try {
            Parser().type()
    ...
    @Test
    fun a03_parser_type () {
        All_new(null, PushbackReader(StringReader("_char"), 2))
        Lexer.lex()
        val tp = Parser().type()
    ...
    fun a06_parser_type_func () {
        All_new(null, PushbackReader(StringReader("func @[] -> () -> ()"), 2))
        Lexer.lex()
        val tp = Parser().type()
    ...
    fun a09_parser_type_ptr_ok () {
        All_new(null, PushbackReader(StringReader("/()@x"), 2))
        Lexer.lex()
        val tp = Parser().type()
    ...
    fun a09_parser_type_ptr_err2 () {
        All_new(null, PushbackReader(StringReader("/()@LOCAL"), 2))
        Lexer.lex()
        val tp = Parser().type()
    ...
    fun a10_parser_type_ptr1 () {
        All_new(null, PushbackReader(StringReader("/List@GLOBAL"), 2))
        Lexer.lex()
        val tp = Parser().type()
    ...
    fun a10_parser_type_ptr2 () {
        All_new(null, PushbackReader(StringReader("/<[/List@GLOBAL]>@LOCAL"), 2))
        Lexer.lex()
        val tp = Parser().type()
    ...
    fun a13_parser_type_pointer_scope () {
        All_new(null, PushbackReader(StringReader("//() @a @b"), 2))
        Lexer.lex()
        val tp = Parser().type()
    ...
    fun b08_parser_expr_nat () {
        All_new(null, PushbackReader(StringReader("_x:_int"), 2))
        Lexer.lex()
        val e = Parser().expr()
    ...
    @Test
    fun b10_parser_var () {
        All_new(null, PushbackReader(StringReader("Point"), 2))
        Lexer.lex()
        try {
            Parser().expr()
            error("impossible case")
    ...
    fun b08_parser_expr_disc_err () {
        All_new(null, PushbackReader(StringReader("l!0"), 2))
        Lexer.lex()
        try {
            Parser().expr()
            error("impossible case")
    ...
    fun b11_parser_expr_call () {
        All_new(null, PushbackReader(StringReader("f ()\n()\n()"), 2))
        Lexer.lex()
        val e = Parser().expr()
    ...
    fun b12_parser_expr_call () {
        All_new(null, PushbackReader(StringReader("f1 f2\nf3\n()"), 2)) // f1 (f2 (f3 ()))
        Lexer.lex()
        val e = Parser().expr()
    ...
    fun b14_parser_expr_cons_err_1 () {
        All_new(null, PushbackReader(StringReader("<.1 ("), 2))
        Lexer.lex()
        try {
            Parser().expr()
            error("impossible case")
    ...
    fun b15_parser_expr_cons_err () {
        All_new(null, PushbackReader(StringReader("<.0>"), 2))
        Lexer.lex()
        try {
            Parser().expr()
            error("impossible case")
    ...
    fun b17_parser_expr_cons () {
        All_new(null, PushbackReader(StringReader("<.2 <.1 [(),()]>:<()>>:<()>"), 2))
        Lexer.lex()
        val e = Parser().expr()
    ...
    fun b18_parser_expr_index () {
        All_new(null, PushbackReader(StringReader("x.1"), 2))
        Lexer.lex()
        val e = Parser().expr()
    ...
    fun b19_parser_expr_index () {
        All_new(null, PushbackReader(StringReader("x () .10"), 2))
        Lexer.lex()  // x [() .10]
        val e = Parser().expr()
    ...
    fun b28_parser_expr_disc () {
        All_new(null, PushbackReader(StringReader("arg.1\\!1.1"), 2))
        Lexer.lex()
        val e = Parser().expr()
    ...
    @Test
    fun b29 () {
        All_new(null, PushbackReader(StringReader("y\\!1.2\\!1.1"), 2))
        Lexer.lex()
        val e = Parser().attr()
        //println(e)
    ...
    fun c01_parser_stmt_var () {
        All_new(null, PushbackReader(StringReader("var x: ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    fun c04_parser_stmt_var_caret () {
        All_new(null, PushbackReader(StringReader("var x: () @a"), 2))
        Lexer.lex()
        try {
            Parser().stmts()
            error("impossible case")
    ...
    fun c05_parser_stmt_var_global () {
        All_new(null, PushbackReader(StringReader("var x: /()@1"), 2))
        Lexer.lex()
        try {
            Parser().stmts()
            error("impossible case")
    ...
    fun c03_parser_stmt_call () {
        All_new(null, PushbackReader(StringReader("call () ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    fun c05_parser_stmt_call () {
        All_new(null, PushbackReader(StringReader("call f ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    fun c07_parser_stmt_call () {
        All_new(null, PushbackReader(StringReader("call _printf:func@[]->()->() ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    fun c07_parser_stmt_output () {
        All_new(null, PushbackReader(StringReader("output std ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    fun c08_parser_stmt_input () {
        All_new(null, PushbackReader(StringReader("set x = input std (): _int"), 2))
        Lexer.lex()
        val s = Parser().stmt()
        //assert(s is Stmt.Call && s.call.f is Expr.Dnref && ((s.call.f as Expr.Dnref).ptr is Expr.Var) && ((s.call.f as Expr.Dnref).ptr as Expr.Var).tk_.str=="output_std")
    ...
    fun c09_parser_stmt_input () {
        All_new(null, PushbackReader(StringReader("input std (): _int"), 2))
        Lexer.lex()
        val s = Parser().stmt()
        //assert(s is Stmt.Call && s.call.f is Expr.Dnref && ((s.call.f as Expr.Dnref).ptr is Expr.Var) && ((s.call.f as Expr.Dnref).ptr as Expr.Var).tk_.str=="output_std")
    ...
    fun c08_parser_stmt_seq () {
        All_new(null, PushbackReader(StringReader("call f() ; call _printf:func@[]->()->() () call g()"), 2))
        Lexer.lex()
        val s = Parser().stmts()
        assert (
    ...
    fun c10_parser_stmt_if () {
        All_new(null, PushbackReader(StringReader("if () {} else { call f() }"), 2))
        Lexer.lex()
        val s = Parser().stmt()
        assert (
    ...
    fun c11_parser_stmt_if_err () {
        All_new(null, PushbackReader(StringReader("if <.2()>:<()> {}"), 2))
        Lexer.lex()
        try {
            Parser().stmts()
            error("impossible case")
    ...
    fun c11_parser_stmt_if () {
        All_new(null, PushbackReader(StringReader("if <.2()>:<()> {} else {}"), 2))
        Lexer.lex()
        val s = Parser().stmt()
        assert (
    ...
    @Test
    fun c12_parser_func () {
        All_new(null, PushbackReader(StringReader("set f = func () { }"), 2))
        Lexer.lex()
        try {
            Parser().stmt()
            error("impossible case")
    ...
    @Test
    fun c13_parser_func () {
        All_new(null, PushbackReader(StringReader("set f = func @[] -> () -> () { return }"), 2))
        Lexer.lex()
        val s = Parser().stmt()
        assert (
    ...
    @Test
    fun c14_parser_ret () {
        All_new(null, PushbackReader(StringReader("return"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    @Test
    fun c14_parser_nat () {
        All_new(null, PushbackReader(StringReader("native _{xxx}"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    fun c14_parser_nat_type () {
        All_new(null, PushbackReader(StringReader("native type _{xxx}"), 2))
        Lexer.lex()
        val s = Parser().stmt()
        assert(s is Stmt.Native && s.tk_.src=="xxx" && s.istype)
    }
    @Test
    fun c15_parser_nat () {
        All_new(null, PushbackReader(StringReader("_("), 2))
        Lexer.lex()
        try {
            Parser().stmt()
            error("impossible case")
    ...
    @Test
    fun c16_parser_nat () {
        All_new(null, PushbackReader(StringReader("native _{${D}xxx}"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    @Test
    fun c15_parser_loop () {
        All_new(null, PushbackReader(StringReader("loop { break }"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    @Test
    fun c16_parser_set () {
        All_new(null, PushbackReader(StringReader("set s = ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    @Test
    fun c17_parser_var () {
        All_new(null, PushbackReader(StringReader("set c = arg.1\\!1.1"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    @Test
    fun d02_stmt_spawn () {
        All_new(null, PushbackReader(StringReader("set x = spawn f ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    @Test
    fun d03_stmt_loop () {
        All_new(null, PushbackReader(StringReader("loop tk in () {}"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    @Test
    fun d04_loop () {
        All_new(null, PushbackReader(StringReader("loop () in @LOCAL {}"), 2))
        Lexer.lex()
        try {
            Parser().stmt()
            error("impossible case")
    ...
    @Test
    fun d05_loop () {
        All_new(null, PushbackReader(StringReader("loop e {}"), 2))
        Lexer.lex()
        try {
            Parser().stmt()
            error("impossible case")
    ...
    @Test
    fun d06_loop () {
        All_new(null, PushbackReader(StringReader("loop e in {}"), 2))
        Lexer.lex()
        try {
            Parser().stmt()
            error("impossible case")
    ...
    @Test
    fun d07_error () {
        All_new(null, PushbackReader(StringReader("x.y"), 2))
        Lexer.lex()
        try {
            Parser().expr()
            error("impossible case")
    ...
    @Test
    fun d08_ok () {
        All_new(null, PushbackReader(StringReader("set x.pub = ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    @Test
    fun noclo_d10_tassk () {
        All_new(null, PushbackReader(StringReader("active {} task @[]->()->()->()"), 2))
        Lexer.lex()
        val tp = Parser().type()
    ...
    @Test
    fun e01_typedef () {
        All_new(null, PushbackReader(StringReader("type Unit = ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    @Test
    fun e02_typedef () {
        All_new(null, PushbackReader(StringReader("var x: Unit"), 2))
        Lexer.lex()
        val s = Parser().stmt()
