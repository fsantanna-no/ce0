...
class TParser {
    ...
    fun b08_parser_expr_nat () {
        All_new(PushbackReader(StringReader("_x:_int"), 2))
        Lexer.lex()
        val e = Parser().expr()
    ...
    fun b08_parser_expr_disc_err () {
        All_new(PushbackReader(StringReader("l!0"), 2))
        Lexer.lex()
        try {
            Parser().expr()
            error("impossible case")
    ...
    fun b11_parser_expr_call () {
        All_new(PushbackReader(StringReader("f ()\n()\n()"), 2))
        Lexer.lex()
        val e = Parser().expr()
    ...
    fun b12_parser_expr_call () {
        All_new(PushbackReader(StringReader("f1 f2\nf3\n()"), 2)) // f1 (f2 (f3 ()))
        Lexer.lex()
        val e = Parser().expr()
    ...
    fun b15_parser_expr_cons_err () {
        All_new(PushbackReader(StringReader("<.0>"), 2))
        Lexer.lex()
        try {
            Parser().expr()
            error("impossible case")
    ...
    fun b18_parser_expr_index () {
        All_new(PushbackReader(StringReader("x.1"), 2))
        Lexer.lex()
        val e = Parser().expr()
    ...
    fun b19_parser_expr_index () {
        All_new(PushbackReader(StringReader("x () .10"), 2))
        Lexer.lex()  // x [() .10]
        val e = Parser().expr()
    ...
    fun b28_parser_expr_disc () {
        All_new(PushbackReader(StringReader("arg.1\\!1.1"), 2))
        Lexer.lex()
        val e = Parser().expr()
    ...
    @Test
    fun b29 () {
        All_new(PushbackReader(StringReader("y\\!1.2\\!1.1"), 2))
        Lexer.lex()
        val e = Parser().attr()
        //println(e)
    ...
    fun c04_parser_stmt_var_caret () {
        All_new(PushbackReader(StringReader("var x: () @a"), 2))
        Lexer.lex()
        try {
            Parser().stmts()
            error("impossible case")
    ...
    fun c05_parser_stmt_var_global () {
        All_new(PushbackReader(StringReader("var x: /()@1"), 2))
        Lexer.lex()
        try {
            Parser().stmts()
            error("impossible case")
    ...
    fun c03_parser_stmt_call () {
        All_new(PushbackReader(StringReader("call () ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    fun c05_parser_stmt_call () {
        All_new(PushbackReader(StringReader("call f ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    fun c07_parser_stmt_call () {
        All_new(PushbackReader(StringReader("call _printf:func@[]->()->() ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    fun c07_parser_stmt_output () {
        All_new(PushbackReader(StringReader("output std ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    fun c08_parser_stmt_input () {
        All_new(PushbackReader(StringReader("set x = input std (): _int"), 2))
        Lexer.lex()
        val s = Parser().stmt()
        //assert(s is Stmt.Call && s.call.f is Expr.Dnref && ((s.call.f as Expr.Dnref).ptr is Expr.Var) && ((s.call.f as Expr.Dnref).ptr as Expr.Var).tk_.str=="output_std")
    ...
    fun c09_parser_stmt_input () {
        All_new(PushbackReader(StringReader("input std (): _int"), 2))
        Lexer.lex()
        val s = Parser().stmt()
        //assert(s is Stmt.Call && s.call.f is Expr.Dnref && ((s.call.f as Expr.Dnref).ptr is Expr.Var) && ((s.call.f as Expr.Dnref).ptr as Expr.Var).tk_.str=="output_std")
    ...
    fun c08_parser_stmt_seq () {
        All_new(PushbackReader(StringReader("call f() ; call _printf:func@[]->()->() () call g()"), 2))
        Lexer.lex()
        val s = Parser().stmts()
        assert (
    ...
    fun c10_parser_stmt_if () {
        All_new(PushbackReader(StringReader("if () {} else { call f() }"), 2))
        Lexer.lex()
        val s = Parser().stmt()
        assert (
    ...
    fun c11_parser_stmt_if_err () {
        All_new(PushbackReader(StringReader("if <.2()>:<()> {}"), 2))
        Lexer.lex()
        try {
            Parser().stmts()
            error("impossible case")
    ...
    fun c11_parser_stmt_if () {
        All_new(PushbackReader(StringReader("if <.2()>:<()> {} else {}"), 2))
        Lexer.lex()
        val s = Parser().stmt()
        assert (
    ...
    @Test
    fun c12_parser_func () {
        All_new(PushbackReader(StringReader("set f = func () { }"), 2))
        Lexer.lex()
        try {
            Parser().stmt()
            error("impossible case")
    ...
    @Test
    fun c14_parser_ret () {
        All_new(PushbackReader(StringReader("return"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    fun c14_parser_nat_type () {
        All_new(PushbackReader(StringReader("native type _{xxx}"), 2))
        Lexer.lex()
        val s = Parser().stmt()
        assert(s is Stmt.Native && s.tk_.src=="xxx" && s.istype)
    }
    @Test
    fun c15_parser_nat () {
        All_new(PushbackReader(StringReader("_("), 2))
        Lexer.lex()
        try {
            Parser().stmt()
            error("impossible case")
    ...
    @Test
    fun c16_parser_set () {
        All_new(PushbackReader(StringReader("set s = ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    @Test
    fun c17_parser_var () {
        All_new(PushbackReader(StringReader("set c = arg.1\\!1.1"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    @Test
    fun d04_loop () {
        All_new(PushbackReader(StringReader("loop () in @LOCAL {}"), 2))
        Lexer.lex()
        try {
            Parser().stmt()
            error("impossible case")
    ...
    @Test
    fun d05_loop () {
        All_new(PushbackReader(StringReader("loop e {}"), 2))
        Lexer.lex()
        try {
            Parser().stmt()
            error("impossible case")
    ...
    @Test
    fun d06_loop () {
        All_new(PushbackReader(StringReader("loop e in {}"), 2))
        Lexer.lex()
        try {
            Parser().stmt()
            error("impossible case")
    ...
    @Test
    fun d07_error () {
        All_new(PushbackReader(StringReader("x.y"), 2))
        Lexer.lex()
        try {
            Parser().expr()
            error("impossible case")
    ...
    @Test
    fun e01_typedef () {
        All_new(PushbackReader(StringReader("type Unit = ()"), 2))
        Lexer.lex()
        val s = Parser().stmt()
    ...
    @Test
    fun e02_typedef () {
        All_new(PushbackReader(StringReader("var x: Unit"), 2))
        Lexer.lex()
        val s = Parser().stmt()
