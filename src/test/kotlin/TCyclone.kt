...
class TCyclone {
    ...
    fun strcpy_01() {
        val out = all(
            """
            var strcpy: [/_char@a_1,/_char@b_1] -> /_char@a_1
            set strcpy = func [/_char@a_1,/_char@b_1] -> /_char@a_1 {
                return arg.1
            }
            var s1: /_char@local
    ...
    fun strdup_02() {
        val out = all(
            """
            var strdup: [/_char@_1] -> /_char@global
            set strdup = func [/_char@_1] -> /_char@global {
