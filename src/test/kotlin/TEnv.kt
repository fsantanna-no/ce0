...
*/
    ...
    fun e11_func_err () {
        ...
        """.trimIndent())
        //assert(out == "(ln 2, col 7): invalid assignment : type mismatch") { out }
        assert(out == "(ln 2, col 28): invalid function type : pool arguments are not continuous") { out }
        //assert(out == "OK") { out }
    }
    @Test
    fun e12_func_ok () {
    ...
    fun e12_call_err () {
        ...
        assert(out == "(ln 7, col 24): invalid call : incompatible scopes") { out }
    ...
    fun e15_call_err () {
        ...
        //assert(out == "(ln 7, col 22): invalid call : type mismatch") { out }
        assert(out == "(ln 7, col 32): invalid call : incompatible scopes") { out }
    }
    @Test
    fun e16_call_ok () {
        val out = inp2env("""
    ...
    fun g18_ptr_func_err () {
        ...
        """.trimIndent())
        assert(out == "(ln 8, col 23): invalid call : incompatible scopes") { out }
        //assert(out == "(ln 8, col 13): invalid call : type mismatch") { out }
        //assert(out == "(ln 8, col 11): invalid assignment : type mismatch") { out }
    }
    ...
    fun p07_pool_err () {
        ...
        assert(out == "(ln 1, col 29): invalid function type : pool arguments are not continuous") { out }
    }
    @Test
    fun p08_pool_err () {
        val out = inp2env("""
    ...
    fun strcpy_01() {
        val out = inp2env(
            ...
            var s1: ()
            call f [@local,@local,/s1,/s1]: @local
        """.trimIndent()
        )
        assert(out == "OK") { out }
    }}
