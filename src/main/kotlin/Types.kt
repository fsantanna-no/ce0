    ...
    fun fe (e: Expr) {
        e.type = e.type ?: when (e) {
            is Expr.Upref -> e.pln.type!!.let {
                ...
                Type.Ptr(e.tk_, scp1, scp1.scope(e), it).clone(e,e.tk.lin,e.tk.col)
            }
            ...
            is Expr.New   -> Type.Ptr(Tk.Chr(TK.CHAR,e.tk.lin,e.tk.col,'/'), e.scp1!!, e.scp1!!.scope(e), e.arg.type!!).clone(e,e.tk.lin,e.tk.col)
