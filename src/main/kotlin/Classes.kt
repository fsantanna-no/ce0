...
sealed class Expr (val tk: Tk, var wup: Any?, var wenv: Any?, var wtype: Type?) {
    ...
    data class UNull (val tk_: Tk.Num, val xtype: Type): Expr(tk_, null, null, xtype)
    ...
    data class Call  (val tk_: Tk, val f: Expr, val arg: Expr, val xscp1s: Pair<Array<Tk.Scp1>,Tk.Scp1?>, var xscp2s: Pair<Array<Scp2>,Scp2?>?): Expr(tk_, null, null, null)
...
sealed class Stmt (val tk: Tk, var wup: Any?, var wenv: Any?) {
    ...
    data class Awake (val tk_: Tk.Key, val e: Expr.Call): Stmt(tk_, null, null)
    data class Bcast (val tk_: Tk.Key, val scp1: Tk.Scp1, val e: Expr): Stmt(tk_, null, null)
    ...
    data class Block (val tk_: Tk.Chr, val xscp1: Tk.Scp1?, val body: Stmt) : Stmt(tk_, null, null)
}
