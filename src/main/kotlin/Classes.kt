...
sealed class Type (val tk: Tk, var up: Any?, var env: Any?) {
    ...
    data class Func  (val tk_: Tk.Key, val clo: Tk.Scope?, val scps: Array<Tk.Scope>, val inp: Type, val out: Type): Type(tk_, null, null)
    data class Ptr   (val tk_: Tk.Chr, val scope: Tk.Scope, val pln: Type): Type(tk_, null, null)
    data class Rec   (val tk_: Tk.Up): Type(tk_, null, null)
}

sealed class Attr (val tk: Tk, var up: Any?) {
    data class Var   (val tk_: Tk.Str): Attr(tk_, null)
    data class Nat   (val tk_: Tk.Nat, val type_: Type): Attr(tk_, null)
...
sealed class Expr (val tk: Tk, var up: Any?, var env: Any?, var type: Type?) {
    ...
    data class UCons (val tk_: Tk.Num, val type_: Type, val arg: Expr): Expr(tk_, null, null, type_)
    ...
    data class New   (val tk_: Tk.Key, val scp: Tk.Scope, val arg: Expr.UCons): Expr(tk_, null, null, null)
    ...
    data class Call  (val tk_: Tk.Key, val sout: Tk.Scope?, val f: Expr, val sinps: Array<Tk.Scope>, val arg: Expr): Expr(tk_, null, null, null)
