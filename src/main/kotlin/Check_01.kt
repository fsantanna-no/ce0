fun Tk.Scp1.check (up: Any) {
    val ok = when {
        ...
        (up.ups_first {                                     // [@_1, ...] { @_1 }
            it is Expr.Func && it.type.xscp1s.second.any { it.lbl==this.lbl && it.num==this.num }
        } != null) -> true
        else -> false
    }
                ...
                val ok1 = ptrs.all {
                    ...
                    when {
                        ...
                        (
                            ...
                            tp.xscp1s.second.any { it!=null && ptr.lbl==it.lbl && ptr.num==it.num }    // (@_1 -> ...@_1...)
                        ) -> true
                        (tp.ups_first {                     // { @aaa \n ...@aaa... }
